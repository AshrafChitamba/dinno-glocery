      ...
      <section className="pt-3 bg-white container-fluid">
        <div className="row border-bottom mx-2 pb-3 px-lg-5">
          <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-3 mb-sm-0 text-center text-sm-start">
            ...
            <p>
              Find us on all social media platforms: Groco Stores .
            </p>
            <div>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-3 mb-sm-0 text-center text-sm-start">
            ...
            <p className="my-2">
              ...
              <span className="ms-1 hover_slide">(265)995-880-599</span>
            </p>s
            <p className="my-2">
              <IoIosCall color="orange" />
              <span className="ms-1 hover_slide">(265)882-760-686</span>
            </p>
            <p className="my-2">
            ...
            <p className="my-2">
              ...
              <span className="ms-1 hover_slide">Blantyre, Malawi - 776</span>
            </p>
          </div>
        ...
        <div className="py-4 text-center" style={{textTransform: 'capitalize'}}>
          <small>
            created by <span className="text-warning fw-semibold"> Dinnoh Spencer Tembo </span> | all rights reserved
          </small>
        </div>
      </section>
    </div>
